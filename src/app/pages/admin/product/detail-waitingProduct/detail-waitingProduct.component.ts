...
@Component({
  selector: 'app-detail-waitingProduct',
  templateUrl: './detail-waitingProduct.component.html',
  styleUrls: ['./detail-waitingProduct.component.css']
})
export class DetailWaitingProductComponent implements OnInit {

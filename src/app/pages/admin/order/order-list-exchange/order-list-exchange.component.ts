...
@Component({
  selector: 'app-order-list-exchange',
  templateUrl: './order-list-exchange.component.html',
  styleUrls: ['./order-list-exchange.component.css']
})
export class OrderListExchangeComponent implements OnInit {
...
onChangeRangePrice(): void {
  ...
  getpayment(item:any):string{
    ...
    }else if(item === PaymentMethod.CARD_MONEY){
